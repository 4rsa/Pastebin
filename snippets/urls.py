...
from .views import my_snippets, all_snippets, create_snippet, snippet_detail, update_snippet, delete_snippet, share_snippet, like_snippet
...
urlpatterns = [
    ...
    path('<int:pk>/share/', share_snippet, name='share_snippet'),
    path('<int:pk>/like/', like_snippet, name='like_snippet'),
]
